...
def arucoDetect(img):
    ...
    if ids is not None:
        ...
        detectedCenter = [(cornerCoors[0][0]-cornerCoors[2][0]), (cornerCoors[0][1]-cornerCoors[3][0]) ]
    else:
        detectedMarkers = False
        lcdMsg = "No markers\ndetected."
...
def angle_detect():
    ...
    '''
    angle = FOV/2*(distanceFromCenter/WIDTH)
    return angle
...
if __name__ == "__main__":
    ...
    camMtx = fread("camera_matrix.npy")
    distCoeffs = fread("dist_coeffs.npy")
